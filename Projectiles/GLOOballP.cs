...
{ 
	public class GLOOballP : ModProjectile
	{


		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Gloo Glob");     //The English name of the projectile
		...
		public override void SetDefaults() {
			...
			AIType = 40;           //Act exactly like default Bullet
		}
		...
		*/
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
			...
			target.AddBuff(ModContent.BuffType<Buffs.GLOOed>(), 300, true);
		}
		...
		{
			int pX = (int)Projectile.position.X;
			int pY = (int)Projectile.position.Y;
			// This code and the similar code above in OnTileCollide spawn dust from the tiles collided with. SoundID.Item10 is the bounce sound you hear.
			WorldGen.PlaceTile(pX / 16, pY / 16, ModContent.TileType<Tiles.GLOOtile>(), false, false, -1, 0);
