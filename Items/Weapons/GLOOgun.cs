...
{
	public class GLOOgun : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("GLOO gun");
			Tooltip.SetDefault("Gelifoam Lattice Organism Obstructor\n		You are prey no longer");
		}
		...
		public override void SetDefaults()
		{
			...
			Item.shoot = ModContent.ProjectileType<Projectiles.GLOOballP>(); //idk why but all the guns in the vanilla source have this
			Item.shootSpeed = 10f; // the speed of the projectile (measured in pixels per frame)
			Item.useAmmo = ModContent.ItemType<GLOOcan>(); // The "ammo Id" of the ammo item that this weapon uses. Note that this is not an item Id, but just a magic value.
		}
